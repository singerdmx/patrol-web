...
describe UserPreferencesController do
  ...
  describe "GET index" do
    it "assigns all user_preferences as @user_preferences" do
      ...
      assigns(:user_preferences).should eq([user_preference])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested user_preference as @user_preference" do
      ...
      assigns(:user_preference).should eq(user_preference)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new user_preference as @user_preference" do
      ...
      assigns(:user_preference).should be_a_new(UserPreference)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created user_preference as @user_preference" do
        post :create, {:user_preference => valid_attributes}, valid_session
        assigns(:user_preference).should be_a(UserPreference)
        assigns(:user_preference).should be_persisted
      end

      it "redirects to the created user_preference" do
        post :create, {:user_preference => valid_attributes}, valid_session
        response.should redirect_to(UserPreference.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved user_preference as @user_preference" do
        ...
        UserPreference.any_instance.stub(:save).and_return(false)
        post :create, {:user_preference => {  }}, valid_session
        assigns(:user_preference).should be_a_new(UserPreference)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested user_preference" do
        user_preference = UserPreference.create! valid_attributes
        # Assuming there are no other user_preferences in the database, this
        # specifies that the UserPreference created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        UserPreference.any_instance.should_receive(:update).with({ "these" => "params" })
        put :update, {:id => user_preference.to_param, :user_preference => { "these" => "params" }}, valid_session
      end
      ...
      it "redirects to the user_preference" do
        user_preference = UserPreference.create! valid_attributes
        put :update, {:id => user_preference.to_param, :user_preference => valid_attributes}, valid_session
        response.should redirect_to(user_preference)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the user_preference as @user_preference" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        UserPreference.any_instance.stub(:save).and_return(false)
        put :update, {:id => user_preference.to_param, :user_preference => {  }}, valid_session
        assigns(:user_preference).should eq(user_preference)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the user_preferences list" do
      user_preference = UserPreference.create! valid_attributes
      delete :destroy, {:id => user_preference.to_param}, valid_session
      response.should redirect_to(user_preferences_url)
    end
  end
